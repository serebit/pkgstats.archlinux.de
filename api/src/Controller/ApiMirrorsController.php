...
class ApiMirrorsController extends AbstractController
{
     ...
     * )
     */
    public function mirrorAction(string $name, StatisticsRangeRequest $statisticsRangeRequest): Response
    {
        return $this->json(
    ...
    /**
     * @Route(
     *     "/api/mirrors/{name}/series",
     *      methods={"GET"},
     *      requirements={"name"="^[\w\-:./]{1,191}$"},
     *      name="app_api_mirrors_series"
     * )
     * @param string $name
     * @param StatisticsRangeRequest $statisticsRangeRequest
     ...
     * @OA\Tag(name="mirrors")
     * @OA\Response(
     *     description="Returns list of mirrors popularities",
     *     response=200,
     *     @Model(type=PopularityList::class)
     * )
     * @OA\Parameter(
     ...
     *     required=false,
     *     in="query",
     *     description="Search by mirror name",
     *     @OA\Schema(
     *         type="string",
     *         maxLength=191
     *     )
